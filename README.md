...
![低维场景$(200,50)$的收敛云雾图](figures/lasso_convergence_cloud_100_trials(200,50).png)
...
![低维场景$(200,50)$算法性能比较（左：次优性箱线图；右：计算时间散点图）](figures/lasso_performance_comparison_100_trials(200,50).png)
...
![中维场景$(1000,200)$的收敛云雾图](figures/lasso_convergence_cloud_100_trials(1000,200).png)
...
![中维场景$(1000,200)$算法性能比较（左：次优性箱线图；右：计算时间散点图）](figures/lasso_performance_comparison_100_trials(1000,200).png)
...
![高维场景$(500,1000)$的收敛云雾图](figures/lasso_convergence_cloud_100_trials(500,1000).png)

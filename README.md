...
![中维场景$(1000,200)$的收敛云雾图](lasso_convergence_cloud_100_trials(1000,200)[2].png)
...
![高维场景$(500,1000)$算法性能比较（左：次优性箱线图；右：计算时间散点图）](lasso_performance_comparison_100_trials(500,1000)[1].png)
